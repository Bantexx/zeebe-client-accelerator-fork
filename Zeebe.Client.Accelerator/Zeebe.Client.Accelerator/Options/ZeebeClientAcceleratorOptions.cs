...
namespace Zeebe.Client.Accelerator.Options
{
    public class ZeebeClientAcceleratorOptions
    {
        ...
        public class WorkerOptions
        {
            ...
            public virtual long StreamTimeoutInMilliseconds { get; set; }
            public virtual TimeSpan StreamTimeout { get { return TimeSpan.FromMilliseconds(StreamTimeoutInMilliseconds); } }
