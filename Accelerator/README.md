...
* Zeebe C# client project from this repository (`Client/Client.csproj`)
...
The solution contains a direct `ProjectReference` from Accelerator to the local Zeebe client project (`../Client/Client.csproj`).
